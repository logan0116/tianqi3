...
#             try:
#                 self.node_dict[node] = pil_loader('../images/' + node + '/image_0.jpg')
#             except FileNotFoundError:
#                 self.node_dict[node] = torch.zeros(3, 800, 800)
#         # link
...
#         # 转换成索引
#         self.s_list = [node_dict[link[0]] for link in self.link_list]
#         self.r_list = [label_dict[link[1]] for link in self.link_list]
#         self.t_list = [node_dict[link[2]] for link in self.link_list]
#
